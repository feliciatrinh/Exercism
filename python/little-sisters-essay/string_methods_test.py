...
from string_methods import (capitalize_title,
                            capitalize_title_not_built_in,
                            check_sentence_ending,
                            check_sentence_ending_not_built_in,
                            clean_up_spacing,
                            replace_word_choice)
...
class LittleSistersEssayTest(unittest.TestCase):
    ...
    def test_capitalize_word(self):
        ...
        self.assertEqual(capitalize_title_not_built_in("canopy"), expected, msg=error_message)
    ...
    def test_sentence_ending(self):
        ...
        test_sentence = "Snails can sleep for 3 years."
        actual_result = check_sentence_ending(test_sentence)
        expected = True
        ...
        self.assertEqual(actual_result, expected, msg=error_message)
        self.assertEqual(check_sentence_ending_not_built_in(test_sentence), expected, msg=error_message)
